...
let myEmail = "alexandrnick@gmail.com";
...
const myName = "name";
const is = "is";
const fullName = `Hello ${my} ${myName} ${is} Sasha.`
...
let userName = "Alex";
let paymentCheck = "20$";
let alertPaymentCheck = `Thank's, ${userName} for paying ${paymentCheck}`;
alert(alertPaymentCheck);
